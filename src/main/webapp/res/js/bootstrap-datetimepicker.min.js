...
(function (f, c) {
    ...
    var i = function (l, k) {
        ...
        //*------------------------------true让清空按钮显示
        this.clearBtn = (k.clearBtn || this.element.data("date-clear-btn") || true);
    ...
    var g = {
        ...
        footTemplate: '<tfoot><tr><th colspan="4" class="today"></th><th colspan="3" class="clear"></th></tr></tfoot>'
    };
