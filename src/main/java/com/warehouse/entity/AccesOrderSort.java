...
public class AccesOrderSort {
     ...
     * 成衣类型
     */
    private String clothCategories;

    /**
     * 面料成分
     */
    private String fabricComponent;
    ...
    public void setSpecFctryDate(String specFctryDate) {
        this.specFctryDate = specFctryDate;
    }
    ...
    public void setSpecFctryInfoUptt(String specFctryInfoUptt) {
        this.specFctryInfoUptt = specFctryInfoUptt;
    }
    ...
    public String getClothCategories() {
        return clothCategories;
    }

    public void setClothCategories(String clothCategories) {
        this.clothCategories = clothCategories;
    }

    public String getFabricComponent() {
        return fabricComponent;
    }

    public void setFabricComponent(String fabricComponent) {
        this.fabricComponent = fabricComponent;
    }
    ...
    public void setAccesOneSerialNum(String accesOneSerialNum) {
        this.accesOneSerialNum = accesOneSerialNum;
    }
    ...
    public void setAccesOneEtalonDescription(String accesOneEtalonDescription) {
        this.accesOneEtalonDescription = accesOneEtalonDescription;
    }
    ...
    public void setAccesTwoSerialNum(String accesTwoSerialNum) {
        this.accesTwoSerialNum = accesTwoSerialNum;
    }
    ...
    public void setAccesTwoEtalonDescription(String accesTwoEtalonDescription) {
        this.accesTwoEtalonDescription = accesTwoEtalonDescription;
    }
    ...
    public void setAccesThreeSerialNum(String accesThreeSerialNum) {
        this.accesThreeSerialNum = accesThreeSerialNum;
    }
    ...
    public void setAccesThreeEtalonDescription(String accesThreeEtalonDescription) {
        this.accesThreeEtalonDescription = accesThreeEtalonDescription;
    }
    ...
    public void setAccesFourSerialNum(String accesFourSerialNum) {
        this.accesFourSerialNum = accesFourSerialNum;
    }
    ...
    public void setAccesFourEtalonDescription(String accesFourEtalonDescription) {
        this.accesFourEtalonDescription = accesFourEtalonDescription;
    }
    ...
    public void setAccesFiveSerialNum(String accesFiveSerialNum) {
        this.accesFiveSerialNum = accesFiveSerialNum;
    }
    ...
    public void setAccesFiveEtalonDescription(String accesFiveEtalonDescription) {
        this.accesFiveEtalonDescription = accesFiveEtalonDescription;
    }
    ...
    public void setAccesSixSerialNum(String accesSixSerialNum) {
        this.accesSixSerialNum = accesSixSerialNum;
    }
    ...
    public void setAccesSixEtalonDescription(String accesSixEtalonDescription) {
        this.accesSixEtalonDescription = accesSixEtalonDescription;
    }
    ...
    public void setAccesOderSynchTime(String accesOderSynchTime) {
        this.accesOderSynchTime = accesOderSynchTime;
    }
    ...
    public void setAccesReadyDistributeTime(String accesReadyDistributeTime) {
        this.accesReadyDistributeTime = accesReadyDistributeTime;
    }
    ...
    public void setAccesDisposeTimeCspt(String accesDisposeTimeCspt) {
        this.accesDisposeTimeCspt = accesDisposeTimeCspt;
    }
    ...
    public void setAccesRemarks(String accesRemarks) {
        this.accesRemarks = accesRemarks;
    }
    ...
    public void setAccesMarkStatus(String accesMarkStatus) {
        this.accesMarkStatus = accesMarkStatus;
    }
    ...
    public void setReadySumSort(String readySumSort) {
        this.readySumSort = readySumSort;
    }
}