...
public class FabricOutflowReady implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8919296001326561450L;
	...
	public FabricOutflowReady(int begin, int end, FabricOutflowReady fabricOutflowReady) {
		super();
