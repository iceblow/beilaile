...
public class ReturnRepairDoucuments {
	...
	public ReturnRepairDoucuments(){
		super();
	}

	public ReturnRepairDoucuments(Integer begin, Integer end, String vendorCode, String commoditycCode, String girard,
			String factory) {
		super();
		this.begin = begin;
		this.end = end;
