...
public class FabricStorage {
	...
	private String fabricStorageState;
	private String confirmStorageTime;
	private String fabricMaterialB;
	
	public String getFabricMaterialB() {
		return fabricMaterialB;
	}

	public void setFabricMaterialB(String fabricMaterialB) {
		this.fabricMaterialB = fabricMaterialB;
	}

	public String getFabricStorageState() {
		return fabricStorageState;
	}

	public void setFabricStorageState(String fabricStorageState) {
		this.fabricStorageState = fabricStorageState;
	}

	public String getConfirmStorageTime() {
		return confirmStorageTime;
	}

	public void setConfirmStorageTime(String confirmStorageTime) {
		this.confirmStorageTime = confirmStorageTime;
	}
