...
public class ProblemNotGrant {
	...
	public ProblemNotGrant(Integer begin, Integer end, String wave, String clouthName,String productCode, String factory, String orderType,
			String piecesApproved) {
		super();
		this.begin = begin;
		this.end = end;
		this.wave = wave;
