...
public interface DistributionCompletedOrderService {
	...
	// 根据id查询
	DistributionCompletedOrder findDistributionCompletedOrderById(Integer id);

	// 确认入库
	Integer updateDistributionCompletedOrderByStorage(Integer id);
}
