...
@Controller
@RequestMapping("ReturnRepairDoucuments")
public class ReturnRepairDoucumentsController {
	
@Resource
private ReturnRepairDoucumentsService returnrepairdoucumentsService;
 ...
 */
	...
	@ResponseBody
	public int addReturnRepairDoucuments(ReturnRepairDoucuments retur){
	int flag = 0;
	//总量
...
//	}
	...
	@ResponseBody
	public int deleteReturnRepairDoucuments(ReturnRepairDoucuments record){
		int flag = 0;
	...
	public ReturnRepairDoucuments selectByPrimaryKey(Integer sid){
		ReturnRepairDoucuments retur = this.returnrepairdoucumentsService.selectByPrimaryKey(sid);
		return retur;	
	}
	...
	@ResponseBody
	public int updateReturnRepairDoucuments(ReturnRepairDoucuments retur){
	...
	@ResponseBody
	public Map<String, Object> bylikeReturnRepairDoucuments(ReturnRepairDoucuments retur, PageUtil page){
		// 传送至前台的map对象
		...
		// map对象中存的数据
		List<ReturnRepairDoucuments> returnrepairdoucuments = this.returnrepairdoucumentsService
				.ReturnRepairDoucumentsbylike((new ReturnRepairDoucuments(page.getReqult()[0]
				,page.getReqult()[1]
				,retur.getVendorCode()
